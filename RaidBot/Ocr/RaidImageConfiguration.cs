			...
			for (var y = 0; y < imageHeight; y++)
			{
				for (var x = 0; x < imageWidth; x++)
				{
					...
					for (var increment = 1; increment < maxDistance; increment++)
					{
						...
						{
							leftBorderFound |= IsColorWithinTolerance(image[xLeft, y], borderColor, colorTolerance);
						}
						...
						{
							rightBorderFound |= IsColorWithinTolerance(image[xRight, y], borderColor, colorTolerance);
						}
